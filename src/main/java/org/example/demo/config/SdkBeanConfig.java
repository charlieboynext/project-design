...
@Configuration
@ConditionalOnProperty(prefix = "system", name = "bcos-enabled", havingValue = "true", matchIfMissing = true)
public class SdkBeanConfig {

    private static final Logger log = LoggerFactory.getLogger(SdkBeanConfig.class);
